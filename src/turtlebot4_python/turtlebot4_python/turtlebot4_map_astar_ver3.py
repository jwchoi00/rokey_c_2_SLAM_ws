...
class PathPlanner(Node):
    def __init__(self):
        ...
        self.timer = self.create_timer(0.5, self.plan_path)
    ...
    def map_callback(self, msg):
        ...
        inflation_radius = 9 #장애물과의 거리 현재 (19,19)pixel만큼 떨어저서 이동
    ...
    def move_to_goal(self):
        ...
        cmd_vel.linear.x = min(0.2, distance)  # Max linear speed is 0.2 m/s
    ...
    def control_rotation(self, angle_diff):
        ...
        max_rot_speed = 1.0  # Max angular velocity in radians/s
        if angle_diff > np.pi:
            angle_diff -= 2 * np.pi
